...
<body>
  <div class="card">
    ...
    <p>Gamitin ang code na ito para i-reset ang iyong password. Mag-e-expire ito sa loob ng <strong>10 minuto</strong>.</p>
    <div class="code">{{ $code }}</div>
    <p class="note">Kung hindi ikaw ang humiling nito, huwag pansinin ang email na ito.</p>
