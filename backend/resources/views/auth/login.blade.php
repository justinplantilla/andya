    ...
    <div class="relative hero-card rounded-2xl border border-bark/10 shadow-2xl shadow-bark/15 w-full max-w-lg px-12 py-14 overflow-hidden">
      ...
      <form method="POST" action="{{ route('login.post') }}" class="anim-4 flex flex-col gap-5">
        ...
        <div class="flex flex-col gap-2">
          ...
          <div class="relative">
            <input type="password" id="login-password" name="password" placeholder="••••••••" class="input-field" style="padding-right:44px" required/>
            <button type="button" onclick="togglePassword('login-password', this)" class="absolute right-3 top-1/2 -translate-y-1/2 text-bark-mid/50 hover:text-bark-mid transition-colors" tabindex="-1">
              <svg id="login-password-eye" xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8"><path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
            </button>
          </div>
        </div>
