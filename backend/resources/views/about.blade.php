...
<head>
  ...
  <title>About Us – Andaya's Native Products</title>
  ...
  <main class="min-h-screen px-5 pt-28 pb-16">
    ...
    <div class="max-w-3xl mx-auto">
      ...
      <div class="anim-3 text-center mb-2">
        <h1 class="font-display text-5xl md:text-6xl font-light text-bark leading-[1.1] tracking-tight">Sino ang</h1>
        <h1 class="font-display text-5xl md:text-6xl font-light italic brand-italic leading-[1.05] tracking-tight">Andaya's?</h1>
      </div>
      ...
      <!-- Story -->
      <div class="anim-4 text-center max-w-xl mx-auto mb-14">
        <p class="text-bark-mid/70 font-sans text-sm leading-relaxed font-light">
          Ang Andaya's Native Products ay isang negosyong nakatuon sa pagpapahalaga at pagpapakalat ng mga
          tunay na likhain ng Pilipino. Mula sa mga produktong gawa sa natural na materyales hanggang sa
          mga tradisyonal na pagkain, bawat piraso ay may kwentong nagmumula sa puso ng ating kultura.
        </p>
      </div>

      <!-- Values -->
      <div class="anim-5 grid grid-cols-1 md:grid-cols-3 gap-5 mb-14">
        <div class="value-card rounded-xl p-7 text-center relative overflow-hidden">
          ...
          <h3 class="font-display text-xl text-bark font-medium mb-2">Kalikasan</h3>
          <p class="text-bark-mid/60 text-xs leading-relaxed font-sans font-light">Gumagamit kami ng mga natural at sustainable na materyales para sa bawat produkto.</p>
        </div>
        <div class="value-card rounded-xl p-7 text-center relative overflow-hidden">
          <div class="absolute top-3 left-3 w-4 h-4 border-t border-l border-gold/30"></div>
          <div class="absolute bottom-3 right-3 w-4 h-4 border-b border-r border-gold/30"></div>
          <div class="text-3xl mb-3">🤝</div>
          <h3 class="font-display text-xl text-bark font-medium mb-2">Komunidad</h3>
          <p class="text-bark-mid/60 text-xs leading-relaxed font-sans font-light">Sumusuporta kami sa mga lokal na artisano at magsasaka sa buong Pilipinas.</p>
        </div>
        <div class="value-card rounded-xl p-7 text-center relative overflow-hidden">
          <div class="absolute top-3 left-3 w-4 h-4 border-t border-l border-gold/30"></div>
          <div class="absolute bottom-3 right-3 w-4 h-4 border-b border-r border-gold/30"></div>
          <div class="text-3xl mb-3">✨</div>
          <h3 class="font-display text-xl text-bark font-medium mb-2">Kalidad</h3>
          <p class="text-bark-mid/60 text-xs leading-relaxed font-sans font-light">Bawat produkto ay dumaan sa mahigpit na pamantayan bago makarating sa inyong mga kamay.</p>
        </div>
      </div>

      <!-- CTA -->
      <div class="anim-6 flex justify-center">
        <a href="{{ route('services') }}" class="flex items-center gap-2.5 bg-bark text-cream text-xs tracking-[0.18em] uppercase font-medium px-7 py-3.5 rounded-sm hover:bg-bark-mid transition-colors duration-300 shadow-md shadow-bark/20">
          Tingnan ang Aming Serbisyo
